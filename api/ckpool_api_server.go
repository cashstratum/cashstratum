...
// "bitcoincash" (production is mainnet). A regtest/testnet4 rig sets it to
// "bchreg"/"bchtest" instead.
...
func handleUserFile(w http.ResponseWriter, r *http.Request) {
	...
	// Was hardcoded to /home/<user>/ckpool/logs/users, which 404s on any host where
